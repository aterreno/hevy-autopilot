...
Design rules (2026-07-17):
  ...
  - Only 2kg add-on plates exist: barbell +4kg (2kg/side), single-end/stack +2kg,
    dumbbells in 2kg-per-hand steps.
...
R1 = {"title": "Full Body 1",
 ...
 "exercises": [
   ...
   ex("79D0BB3A",120,"+4kg (2kg/side) once all sets hit 12.",[work(40)]*3,2),   # Bench Press (Barbell)
   ex("6A6C31A5",90,"+2kg once all sets hit 12.",[work(52)]*3,1),               # Lat Pulldown (Cable)
   ex("11A123F3",75,"+2kg once all sets hit 12.",[work(32.5)]*3),               # Seated Leg Curl (Machine)
...
R2 = {"title": "Full Body 2",
 ...
 "exercises": [
   ex("0222DB42",120,"5 min / ~1 km, easy.",[row()]),
   ex("2B4B7310",120,"Hips back, flat back. +4kg (2kg/side) once all sets hit 12.",
      [work(65)]*3,2),                                     # Romanian Deadlift (Barbell)
   ex("55E6546F",90,"+4kg (2kg/side) once all sets hit 12.",[work(55)]*3,1),    # Bent Over Row (Barbell)
   ...
   ex("B2398CD1",45,"Plate on chest. +2kg once all sets hit 12.",[work(5)]*3),  # Decline Crunch (Weighted)
 ]}
R3 = {"title": "Full Body 3",
 ...
 "exercises": [
   ...
   ex("D7D7FCCE",90,"+2kg once all sets hit 12.",[work(45)]*3,1),               # Landmine Row
   ex("78683336",60,"+2kg once all sets hit 12.",[work(17.5)]*3),               # Chest Fly (Machine)
