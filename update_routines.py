...
U1 = {"title": "Upper 1",
 ...
 "exercises": [
   ...
   ex("79D0BB3A", "Bench Press (Barbell)", 120, "+5kg (2.5/side) once all sets hit 12.", [work(40)]*3, 2),
   ex("55E6546F", "Bent Over Row (Barbell)", 90, "Flat back, pull to the hips. +5kg (2.5/side) once all sets hit 12.", [work(45)]*3, 1),
...
U2 = {"title": "Upper 2",
 ...
 "exercises": [
   ...
   ex("NEW:FACE_PULL", "Face Pull", 45, "Pull to the face, thumbs back, squeeze the rear delts. +2kg once all sets hit 12.", [work(15)]*3),
